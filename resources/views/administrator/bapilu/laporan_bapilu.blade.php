...
?>
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4 text-center">
                <h4><img style="width: 150px" src="https://jombang.bawaslu.go.id/wp-content/uploads/2019/04/Logo-Bawaslu-2018-Icon-PNG-HD.png" alt=""></h4>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col mx-auto text-center">
                                                <b class="fs-4 mx-auto target-container<?=$solut->id?>"> </b>
                                                  ...
                                                  data =  [@foreach($jmlh_kecurangan as $jmlh)  '{{$jmlh->tps_id}}',  @endforeach];
