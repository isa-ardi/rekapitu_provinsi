        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="row justify-content-end">
                    <div class="col-4">
                        <a href="{{url('')}}/administrator/print-index-tsm" target="_blank" class="btn btn-block btn-dark ml-2 mr-2 w-100"> Print &nbsp;&nbsp;<i class="fa fa-print"></i></a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered w-100">
                                    <tr>
                                        <td><b class="text-danger">PHU</b> (Perhitungan Ulang)</td>
                                        <td><b class="text-danger">PA</b> (Pelanggaran Administrasi)</td>
                                    </tr>
                                    <tr>
                                        <td><b class="text-danger">PSU</b> (Pemungutan Suara Ulang)</td>
                                        <td><b class="text-danger">PP</b> (Pelanggaran Pidana)</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap border-bottom dataTable no-footer table-striped table-hover datable" role="grid" id="responsive-datatable_info">
                                        <thead class="bg-dark">
                                            <tr>
                                                <th class="text-white">No</th>
                                                <th class="text-white">Kode</th>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col my-auto text-end">
                                                <a href="{{route('superadmin.solution',encrypt($solut->id))}}" class="my-auto">Lihat <i class="mdi mdi-eye"></i></a> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <center>
                                    <div class="card" style="background-color:white">
                                        <div class="card-body">
                                            <a href="{{url('/') . "/scanning/" . Crypt::encrypt($item['nomor_berkas'])}}" target="_blank" rel="noopener noreferrer">
                      ...
                      <div class="col-lg-12">
                                 <div class="row justify-content-end">
                                    <div class="col-lg-2">
                                      <a href="{{url('')}}/administrator/fraud-data-report"class="btn btn-dark btn-block">Selengkapnya</a>
                                     </div>
                                 </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <a id="Cek" data-bs-toggle="modal" onclick="qrsidang(this)" data-bs-target="#modalQrCode" data-id="{{$ls->tps_id}}" href="#">
                                        {!! QrCode::size(200)->generate($scan_url); !!}
                                    </a>
                                </div>
                            </div>
